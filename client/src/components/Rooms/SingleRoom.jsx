    ...
    <div className="single_room_container">
      ...
      <div className="single_room_detail">
        ...
        <div className="single_room_detail_2_box">
          ...
          <div className="single_room_detail_2_side_2">
            <p className="single_room_detail_2_side_2_1">
              PLEASE SELECT A RATE PACKAGE:
            </p>
            <div className="single_room_detail_2_side_2_2">
              <p className="single_room_detail_2_side_2_2_1">
                <span className="single_room_detail_2_side_2_2_1_1">
                  Standard Rate
                </span>
                <svg
                  className="single_room_detail_2_side_2_2_1_2"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="single_room_detail_2_side_2_2_2">${room.price}</p>
            </div>
            <button
